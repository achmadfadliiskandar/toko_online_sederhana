        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="https://asset-a.grid.id/crop/0x0:0x0/750x500/photo/bolasport/headline_small_30bf3e1bbb897fa91307c9b1440d1faf.jpg" class="d-block" style="width: 100%; height:300px;" alt="raket">
            </div>
            <div class="carousel-item">
    ...
    <div class="row mt-5">
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="https://asset-a.grid.id/crop/0x0:0x0/750x500/photo/bolasport/headline_small_30bf3e1bbb897fa91307c9b1440d1faf.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  Raket Badminton
                </h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="https://disk.mediaindonesia.com/thumbs/700x-/news/2018/07/0677061a4073b5b043939e0a8e790b89.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                Bola Basket
                </h4>
