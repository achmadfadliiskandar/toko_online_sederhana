...
<div class="login-box">
  <div class="login-logo">
    <a href="loginadmin"><b>LOREM</b>IPSUM</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">langsung sign in</p>

      <form action="/tableadmin" method="get">
      @csrf
        <div class="input-group mb-3">
          <input type="username" class="form-control" placeholder="username" name="username" value="Admin Corona-19" readonly>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password" value="coronahilang" readonly>
          <div class="input-group-append">
            <div class="input-group-text">
